...
\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth]{System_Architecture_Overview.drawio.png}
    \caption{HelmTrack System Architecture Overview}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{Detect_and_Log_Violation_Sequence_Diagram.drawio.png}
    \caption{Sequence Diagram: Detect and Log a Helmet Violation}
\end{figure}
